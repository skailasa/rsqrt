use std::arch::x86_64::{__m128, __m128d, __m256, __m256d, _mm256_andnot_ps, _mm256_cmp_ps, _mm256_cvtpd_ps, _mm256_cvtps_pd, _mm256_mul_pd, _mm256_mul_ps, _mm256_rsqrt_ps, _mm256_set1_pd, _mm256_set1_ps, _mm256_set_ps, _mm256_sub_pd, _mm256_sub_ps, _mm_andnot_ps, _mm_cmpeq_ps, _mm_rsqrt_ps, _CMP_EQ_OS};
...
pub fn rqsqrt_approx_intrin_avx_32(r2: __m256) -> __m256 {
    ...
    unsafe {
        _mm256_andnot_ps(_mm256_cmp_ps(r2, pulp::cast(zero), _CMP_EQ_OS),_mm256_rsqrt_ps(r2))
    }
}
...
pub fn rqsqrt_approx_intrin_sse_32(r2: __m128) -> __m128 {
    ...
    unsafe {
        _mm_andnot_ps(_mm_cmpeq_ps(r2, pulp::cast(zero)),_mm_rsqrt_ps(r2))
    }
}
...
pub fn rqsqrt_approx_intrin_avx_64(r2: __m256d) -> __m256d {
    unsafe {
        _mm256_cvtps_pd(rqsqrt_approx_intrin_sse_32(_mm256_cvtpd_ps(r2)))
    }
}
...
pub fn rsqrt_newton_intrin_32(rinv: __m256, r2: __m256, newton_constant: f32) -> __m256 {
    ...
    unsafe {
       ...
       _mm256_mul_ps(rinv, _mm256_sub_ps(newton_constant, _mm256_mul_ps(r2, _mm256_mul_ps(rinv, rinv))))
    }
}
...
pub fn rsqrt_newton_intrin_64(rinv: __m256d, r2: __m256d, newton_constant: __m256d) -> __m256d {
    ...
    unsafe {
       ...
       _mm256_mul_pd(rinv,  _mm256_sub_pd(newton_constant, _mm256_mul_pd(r2, _mm256_mul_pd(rinv, rinv))))
    }
}
